...
input_img_path = '/my_example/images/IMG_0315.jpeg'
output_img_path = '/my_example/images/IMG_0315_unet_inference_visualization.jpeg'
output_ann_path = '/my_example/images/IMG_0315_unet_prediction.json'
