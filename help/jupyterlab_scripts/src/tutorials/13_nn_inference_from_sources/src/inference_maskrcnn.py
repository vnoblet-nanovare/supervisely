...
from supervisely.plugins.nn.mask_rcnn_matterport.src.inference import MaskRCNNSingleImageApplier as model_applier
...
output_img_path = '/my_example/images/00000220_maskrcnn_inference_visualization.jpeg'
output_ann_path = '/my_example/images/00000220_maskrcnn_prediction.json'
...
prediction.draw(visualization_image, color=[255, 0, 0])
res_image = cv2.addWeighted(image, 1, visualization_image, 0.99, 0)
