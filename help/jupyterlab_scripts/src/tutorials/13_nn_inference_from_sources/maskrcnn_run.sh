DOCKER_IMAGE='supervisely/nn-mask-rcnn-keras-tf:latest'
...
HOST_MODEL_DIR=${HOST_TUTORIAL_DIRECTORY}'/data/model_mask_rcnn_coco'  
HOST_PATH_INFERENCE_SCRIPT=${HOST_TUTORIAL_DIRECTORY}'/src/inference_maskrcnn.py'
