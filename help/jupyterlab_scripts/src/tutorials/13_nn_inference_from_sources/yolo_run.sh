DOCKER_IMAGE='supervisely/nn-yolo-v3:latest'
...
HOST_MODEL_DIR=${HOST_TUTORIAL_DIRECTORY}'/data/model_yolo_coco'  
HOST_PATH_INFERENCE_SCRIPT=${HOST_TUTORIAL_DIRECTORY}'/src/inference_yolo.py'
